...
choropleth1 = folium.Choropleth(
    geo_data='./input/georef-united-states-of-america-state.geojson', #geo_data.to_json(), #gdf.to_json(), ##df_final.to_json(),  ####       # Geojson file for the United States
    name="Choropleth (Heat Map) of U.S. Housing Prices",
    data=df_final.to_json(), #df_ungeo, #ungeo, #.to_json(), #  df_final.to_json(),                                                          # df from the data preparation and user selection
